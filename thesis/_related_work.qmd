...
![Panels for existing AI-powered Blender add-ons, such as BlenderGPT and BlenderMCP, shown inside Blender’s sidebar. These tools accept natural-language prompts and execute generated Python directly, emphasizing automation rather than step-by-step instruction.](images/ai_addons_sidebar.png){fig-cap="Figure X. Existing AI add-ons like BlenderGPT and BlenderMCP integrate LLMs into Blender but focus on code execution, not instructional micro-steps. Screenshot by the author, adapted from a test scene." width=100%}
